...
<!-- Functional components are stateless components without any data, computed properties, or even life cycles. 
They are just render functions that are called when the data that has been passed changes.
Functional components are perfect for UI components that don't need to keep any data inside them.
They are a stripped-down version of a component that's used exclusively for performance rendering and visual elements. -->
