...
function validateUser(state) {
  ...
  delete state.password; //delete password property
  state.loading = false;
}
...
function clearUser(state) {
  // get a new clean state from the createState function
  const newState = createState();
  //and iterate over the current state, defining the values of the state properties back to the default values
